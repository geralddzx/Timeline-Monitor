(function (){
	var RealDataPaint = TM.RealDataPaint = function(ring){
		this.ring = ring
	...
	RealDataPaint.prototype.draw = function(){
		...
		this.phasesData.each(function(phaseData){
	...
	RealDataPaint.prototype.createPhaseData = function(startTime, text){
		...
		TM.Timeline.states.each(function(state){
			data[state] = 0
		})
		data.nopp = 0
	...
	RealDataPaint.prototype.parseData = function(time){
		...
		var phaseData = (this.phasesData.last() || this.createPhaseData(time))
		TM.Timeline.states.each(function(state){
